...
var halls2 = [
    ...
    Hall(start: 1, end: 4, length: 22.53, id: 4),
    ...
    Hall(start: 71, end: 72, length: 15.1, id: 103),
...
var rooms3 = [
    ...
    Room(name: "336", startDist: 0.06, hall: 26, x: 272.74, y: 370.38),
...
var halls3 = [
    ...
    Hall(start: 11, end: 12, length: 16.26, id: 13),
    ...
    Hall(start: 12, end: 13, length: 1.41, id: 31),
