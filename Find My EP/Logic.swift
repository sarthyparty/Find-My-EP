...
//    Room(name: "Performing Arts Center Entrance Floor 1 (PAC)", startDist: 0, hall: 56, x: 407.51, y: 402.06),
    ...
    Room(name: "169", startDist: 24.05, hall: 42, x: 287.38, y: 369.07),
    Room(name: "168", startDist: 10.2, hall: 42, x: 301.15, y: 369.07),
    ...
    Room(name: "162", startDist: 48.32, hall: 42, x: 262.34, y: 369.07),
...
var rooms2 = [
    ...
    Room(name: "203", startDist: 5.48, hall: 97, x: 190.59, y: 332.04),
    Room(name: "204", startDist: 1.11, hall: 104, x: 196.07, y: 333.50),
...
var intersects2 = [
    ...
    Intersection(halls: [], id: 34, x: 269.25, y: 441.26),
