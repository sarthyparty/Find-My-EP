...
var halls2 = [
    ...
    Hall(start: 63, end: 67, length: 1.46, id: 105),
]

// Room(name: "", startDist: , hall: , x: , y: ),
var rooms3 = [
    Room(name: "313 Math Resource", startDist: 5.42, hall: 1, x: 87.89, y: 384.78),
    Room(name: "314 Classroom", startDist: 9.66, hall: 0, x: 48.14, y: 390.21),
    Room(name: "315 Classroom", startDist: 0.0, hall: 0, x: 38.48, y: 390.21),
    Room(name: "316 Application Lab", startDist: 0.0, hall: 0, x: 38.48, y: 390.21),
    Room(name: "317 Application Lab", startDist: 6.01, hall: 0, x: 44.49, y: 390.21),
    Room(name: "318 Classroom", startDist: 9.66, hall: 0, x: 48.14, y: 390.21),
    Room(name: "319 Classroom", startDist: 28.64, hall: 0, x: 67.13, y: 390.21),
    Room(name: "320 Computer Programming", startDist: 33.04, hall: 0, x: 71.52, y: 390.21),
...
var intersects3 = [
    ...
    Intersection(halls: [], id: 1, x: 87.89, y: 390.21),
    Intersection(halls: [], id: 2, x: 87.89, y: 384.78),
