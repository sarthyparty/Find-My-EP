...
var rooms = [
    ...
    Room(name: "121", startDist: 2.65, hall: 12, x: 144.85, y: 335.22),
    Room(name: "120", startDist: 4.85, hall: 12, x: 147.05, y: 335.22),
    Room(name: "119", startDist: 4.85, hall: 12, x: 147.05, y: 335.22),
    Room(name: "122", startDist: 36.98, hall: 11, x: 142.2, y: 338.35),
    Room(name: "123", startDist: 17.62, hall: 11, x: 142.2, y: 357.72),
    Room(name: "118", startDist: 17.62, hall: 11, x: 142.2, y: 357.72),
    Room(name: "144 Weight Room", startDist: 24.0, hall: 13, x: 100.2, y: 434.12),
    Room(name: "143 Boys Locker Room", startDist: 42.5, hall: 13, x: 100.2, y: 452.63),
    Room(name: "142 Girls Locker Room", startDist: 29.12, hall: 13, x: 100.2, y: 439.25),
    Room(name: "145 Fitness Room", startDist: 12.44, hall: 13, x: 100.2, y: 422.57),
    Room(name: "146 Training", startDist: 17.2, hall: 9, x: 131.43, y: 410.12),
    Room(name: "147 Locker Room B", startDist: 8.6, hall: 15, x: 156.67, y: 418.73),
...
var rooms2 = [
    ...
    Room(name: "202 English Resource Center (ERC)", startDist: 6.24, hall: 89, x: 223.49, y: 343.74),
    Room(name: "270", startDist: 7.18, hall: 88, x: 229.00, y: 336.56),
    ...
    Room(name: "266", startDist: 7.29, hall: 78, x: 276.70, y: 360.28),
    Room(name: "265", startDist: 21.27, hall: 73, x: 288.47, y: 360.28),
    Room(name: "264", startDist: 9.34, hall: 73, x: 300.40, y: 360.28),
    ...
    Room(name: "227 Student Center East (SCE)", startDist: 0, hall: 16, x: 95.78, y: 435.67),
    ...
    Room(name: "256", startDist: 21.51, hall: 75, x: 265.02, y: 379.47),
    Room(name: "255", startDist: 30.69, hall: 75, x: 253.30, y: 379.47),
    Room(name: "251", startDist: 0, hall: 68, x: 312.32, y: 382.92),
    ...
    Room(name: "240", startDist: 5.57, hall: 38, x: 218.39, y: 429.47),
    ...
    Room(name: "244 Orchestra", startDist: 0, hall: 111, x: 273.98, y: 425.48),
    ...
    Room(name: "248 Stage", startDist: 0, hall: 62, x: 331.04, y: 442.17),
    ...
    Room(name: "229 Dance Studio", startDist: 8.85, hall: 120, x: 107.48, y: 476.88),
    ...
    Room(name: "232 The Nest", startDist: 8.22, hall: 34, x: 194.05, y: 464.30),
    Room(name: "234", startDist: 23.64, hall: 40, x: 122.49, y: 408.38),
    Room(name: "East Side Deli", startDist: 0, hall: 124, x: 111.46, y: 406.07),
    Room(name: "Prairie Grounds Coffee", startDist: 15.59, hall: 2, x: 74.92, y: 372.07),
    Room(name: "New American Grille", startDist: 6.54, hall: 3, x: 74.92, y: 394.20),
...
var halls2 = [
    ...
    Hall(start: 89, end: 60, length: 2.09, id: 96),
    ...
    Hall(start: 59, end: 53, length: 31.10, id: 108),
    Hall(start: 83, end: 91, length: 9.83, id: 109),
    ...
    Hall(start: 14, end: 97, length: 8.40, id: 119),
    Hall(start: 80, end: 97, length: 8.85, id: 120),
    ...
    Hall(start: 64, end: 100, length: 15.96, id: 125),
    Hall(start: 29, end: 100, length: 7.49, id: 126),
