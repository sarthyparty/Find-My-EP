...
//    Room(name: "Performing Arts Center Entrance Floor 1 (PAC)", startDist: 0, hall: 56, x: 407.51, y: 402.06),
    ...
    Room(name: "100 Student Center South (SCS)", startDist: 16.57, hall: 32, x: 206.6, y: 328.03),
    Room(name: "104 Health", startDist: 26.89, hall: 32, x: 207.07, y: 338.38),
    Room(name: "106", startDist: 0.83, hall: 21, x: 183.02, y: 361.59),
    Room(name: "107 Educational Services", startDist: 4.99, hall: 18, x: 165.67, y: 371.83),
    Room(name: "112", startDist: 8.5, hall: 17, x: 160, y: 383.8),
    Room(name: "111", startDist: 8.0, hall: 17, x: 162.15, y: 383.2),
    Room(name: "113", startDist: 2.91, hall: 17, x: 159.19, y: 377.82),
    Room(name: "110", startDist: 1.52, hall: 17, x: 162.08, y: 375.95),
    Room(name: "109", startDist: 14.6, hall: 18, x: 175.2, y: 373.77),
