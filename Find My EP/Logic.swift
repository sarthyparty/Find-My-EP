...
var rooms = [
    Room(name: "130 Classroom", startDist: 10.43, hall: 0, x: 85.39, y: 358.87),
    Room(name: "129 Classroom", startDist: 13.62, hall: 0, x: 88.59, y: 358.87),
    Room(name: "131 Computer Lab", startDist: 9.7, hall: 1, x: 100.2, y: 368.57),
    Room(name: "128 Classroom", startDist: 3.75, hall: 6, x: 103.94, y: 369.72),
    Room(name: "127 Classroom", startDist: 3.75, hall: 6, x: 103.94, y: 369.72),
    Room(name: "126 Classroom", startDist: 21.2, hall: 6, x: 121.4, y: 369.72),
    Room(name: "125 Classroom", startDist: 21.2, hall: 6, x: 121.4, y: 369.72),
    Room(name: "124 Classroom", startDist: 32.43, hall: 6, x: 132.62, y: 369.72),
    Room(name: "117 Classroom", startDist: 9.3, hall: 8, x: 148.63, y: 379.02),
    Room(name: "116 Resource", startDist: 18.05, hall: 8, x: 148.63, y: 387.77),
    Room(name: "115 Classroom", startDist: 20.3, hall: 8, x: 148.63, y: 390.02),
    Room(name: "114A Classroom", startDist: 22.85, hall: 8, x: 148.63, y: 392.57),
    Room(name: "114B Classroom", startDist: 25.55, hall: 8, x: 148.63, y: 395.27),
    Room(name: "132 Student Resource", startDist: 12.17, hall: 3, x: 88.02, y: 389.57),
    Room(name: "133 Offices", startDist: 28.23, hall: 3, x: 71.97, y: 389.57),
    Room(name: "134 Classroom", startDist: 1.34, hall: 5, x: 57.26, y: 383.77),
    Room(name: "135 Classroom", startDist: 13.12, hall: 5, x: 45.48, y: 383.77),
    Room(name: "139 Flex", startDist: 41.6, hall: 3, x: 58.6, y: 389.57),
    Room(name: "138 Classroom", startDist: 41.6, hall: 3, x: 58.6, y: 389.57),
    Room(name: "137 Classroom", startDist: 16.0, hall: 5, x: 42.6, y: 383.77),
    Room(name: "136 Lab", startDist: 16.0, hall: 5, x: 42.6, y: 383.77),
    Room(name: "121 Classroom", startDist: 2.65, hall: 12, x: 144.85, y: 329.6),
    Room(name: "120 Classroom", startDist: 4.85, hall: 12, x: 147.05, y: 329.6),
    Room(name: "119 Classroom", startDist: 4.85, hall: 12, x: 147.05, y: 329.6),
    Room(name: "122 Classroom", startDist: 36.98, hall: 11, x: 142.2, y: 332.73),
    Room(name: "123 Classroom", startDist: 17.62, hall: 11, x: 142.2, y: 352.1),
    Room(name: "118 Classroom", startDist: 17.62, hall: 11, x: 142.2, y: 352.1),
    Room(name: "144 Weight Room", startDist: 24.0, hall: 13, x: 100.2, y: 428.51),
    Room(name: "143 Boys Locker", startDist: 42.5, hall: 13, x: 100.2, y: 447.01),
    Room(name: "142 Girls Locker", startDist: 29.12, hall: 13, x: 100.2, y: 433.63),
    Room(name: "145 Fitness Center", startDist: 12.44, hall: 13, x: 100.2, y: 416.95),
    Room(name: "146 Training", startDist: 17.2, hall: 9, x: 131.43, y: 404.51),
    Room(name: "147 Boys Locker", startDist: 8.6, hall: 15, x: 156.67, y: 413.11),
    Room(name: "151 Girls Locker", startDist: 8.6, hall: 15, x: 156.67, y: 413.11),
    Room(name: "148 Boys Locker", startDist: 29.35, hall: 15, x: 156.67, y: 433.86),
    Room(name: "150 Girls Locker", startDist: 29.35, hall: 15, x: 156.67, y: 433.86),
    Room(name: "151A Office", startDist: 6.02, hall: 15, x: 156.67, y: 410.53),
    
]

//  Intersection(halls: [], id: , x: , y: )
var intersects = [
    Intersection(halls: [], id: 0, x: 74.97, y: 358.87),
    Intersection(halls: [], id: 1, x: 100.2, y: 358.87),
    Intersection(halls: [], id: 2, x: 100.2, y: 369.72),
    Intersection(halls: [], id: 3, x: 100.2, y: 389.57),
    Intersection(halls: [], id: 4, x: 58.6, y: 389.57),
    Intersection(halls: [], id: 5, x: 58.6, y: 383.77),
    Intersection(halls: [], id: 6, x: 41.8, y: 383.77),
    Intersection(halls: [], id: 7, x: 142.2, y: 369.72),
    Intersection(halls: [], id: 8, x: 148.63, y: 369.72),
    Intersection(halls: [], id: 9, x: 148.63, y: 404.51),
    Intersection(halls: [], id: 10, x: 100.2, y: 404.51),
    Intersection(halls: [], id: 11, x: 142.2, y: 329.6),
    Intersection(halls: [], id: 12, x: 157.27, y: 329.6),
    Intersection(halls: [], id: 13, x: 100.2, y: 448.21),
    Intersection(halls: [], id: 14, x: 156.67, y: 404.51),
    Intersection(halls: [], id: 15, x: 156.67, y: 454.34),
...
var halls = [
    ...
    Hall(start: 1, end: 2, length: 10.95, id: 1),
    Hall(start: 2, end: 3, length: 20.03, id: 2),
    Hall(start: 3, end: 4, length: 41.6, id: 3),
    Hall(start: 4, end: 5, length: 5.85, id: 4),
    Hall(start: 5, end: 6, length: 16.81, id: 5),
    Hall(start: 2, end: 7, length: 42.0, id: 6),
    Hall(start: 7, end: 8, length: 6.43, id: 7),
    Hall(start: 8, end: 9, length: 35.11, id: 8),
    Hall(start: 9, end: 10, length: 48.43, id: 9),
    Hall(start: 10, end: 3, length: 15.08, id: 10),
    Hall(start: 7, end: 11, length: 40.48, id: 11),
    Hall(start: 11, end: 12, length: 15.07, id: 12),
    Hall(start: 10, end: 13, length: 44.1, id: 13),
    Hall(start: 9, end: 14, length: 8.04, id: 14),
    Hall(start: 14, end: 15, length: 50.29, id: 15),
